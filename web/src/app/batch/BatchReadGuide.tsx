import {
  BATCH_SNAPSHOT_NOTE,
  PASS_FAIL_LEGEND_FAIL,
  PASS_FAIL_LEGEND_PASS,
  ...
  return (
    <details className="learn-more batch-read-guide">
      ...
      <div className="learn-more-body">
        <p>
          {BATCH_SNAPSHOT_NOTE} Covers <strong>28 public sites</strong> from the
          test plan. Pass/Fail colors stay clear in <strong>Light</strong>,{" "}
          <strong>Dark</strong>, and <strong>System</strong> themes.
        </p>
        ...
        <div className="batch-legend" role="list" aria-label="Color legend">
          <div className="batch-legend-item batch-legend-pass" role="listitem">
            ...
            <span>
              <strong>{PASS_FAIL_LEGEND_PASS}</strong>
            </span>
          </div>
          <div className="batch-legend-item batch-legend-fail" role="listitem">
            <span className="batch-legend-swatch" aria-hidden="true" />
            <span>
              <strong>{PASS_FAIL_LEGEND_FAIL}</strong>
            </span>
          </div>
